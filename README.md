...
0 < N < 10^7
## Input format
The first line contains an integer T denoting test cases. Each test case has a single line containing a single integer N, (The amount of money she has).
## Output Format
Print how many chocolates she can get with her N tk.
## Sample Input 1
3
